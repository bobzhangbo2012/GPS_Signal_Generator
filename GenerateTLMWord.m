...
%  with all 1's , two (2) reserved bits, and six (6) parity bits. The     %
%  input D_start is a 2-bit vector that hold the last two bits of the     %
%  previews word which is used in calculating the parity bits.            %
%                                                                         %
%   +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ %
...
TLM_word = [ TLM_preamble TLM_message TLM_reserve ];
