function message_data = CreateMessageData()
    ...
    subframe_1 = GenerateSubframe1( transmission_week_number, str2bin_array( GetHOWTimeWeek( gps_seconds_of_week )), [ 0 0 ]);
    subframe_2 = GenerateSubframe1( transmission_week_number, str2bin_array( GetHOWTimeWeek( gps_seconds_of_week + 6 )),  subframe_1( 10, 29:30 ));
    subframe_3 = GenerateSubframe1( transmission_week_number, str2bin_array( GetHOWTimeWeek( gps_seconds_of_week + 12 )), subframe_2( 10, 29:30 ));
